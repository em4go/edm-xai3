...
if(tile_width == 0 && length(temp_breaks) > 0) tile_width <- diff(range(model_data_hour_sample$temp_scaled, na.rm = TRUE))/10 # Fallback
if(tile_height == 0 && length(hum_breaks) > 0) tile_height <- diff(range(model_data_hour_sample$hum_scaled, na.rm = TRUE))/10 # Fallback
